...
class Invoice(object):
    ...
    def __init__(self, links=None, id=None, created_by=None, created_name=None, updated_name=None, updated_on=None, line_items=None, paid=None, refund=None, service_fees=None, total=None, references=None, status_code=None, local_vars_configuration=None):  # noqa: E501
